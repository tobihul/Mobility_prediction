...
unique_pH = sort(unique(skipmissing(filtered_RPLC_data.pH)))

counts = []
for pH in unique_pH
    push!(counts, sum(skipmissing(filtered_RPLC_data.pH) .== pH))
end
...
CSV.write("C:\\Users\\uqthulle\\Documents\\pH table.csv", pH_counts)
