...
p_very_mobile = very_mobile/length(REACH_probabilities[:,1])*100
p_mobile = mobile/length(REACH_probabilities[:,1])*100
p_non_mobile = non_mobile/length(REACH_probabilities[:,1])*100
