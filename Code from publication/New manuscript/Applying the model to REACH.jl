...
REACH_data = CSV.read("C:\\Users\\uqthulle\\Downloads\\REACH fingerprints final.csv", DataFrame)
...
rf_class = joblib.load("optimized_random_forest_classifier_RepoRT_improved pH3 and 2.6.joblib")
...
savefig("Plots\\REACH probability densities.png")
...
OPERA_pred_data = CSV.read("C:\\Users\\uqthulle\\Downloads\\OPERA predicted LogKoc and LogD.csv", DataFrame)
...
p_very_mobile = histogram(OPERA_logKoc[indices_very_mobile],  
linecolor=:transparent,
dpi = 300,
xlims = (0,7),
xlabel = ("Predicted logKoc"),
