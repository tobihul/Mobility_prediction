...
minimum((RPLC[nd_entries,end]./100)[2:end])
...
histogram(RPLC_pH3_pH26_data.Modifier./100,
...
chem_space = scatter(RPLC_pH3_pH26_data.MW, RPLC_pH3_pH26_data.XlogP,
zcolor = RPLC_pH3_pH26_data.Modifier./100, dpi = 300,
...
hist_MW = histogram(RPLC_pH3_pH26_data.MW, 
bins = 500, 
...
hist_XLOGP = histogram(RPLC_pH3_pH26_data.XlogP,
bins = 100,  
linecolor=:transparent,
dpi = 300,
xlabel = ("XlogP"),
...
hist_RF = histogram(RPLC_pH3_pH26_data.Retention_factors,  
linecolor=:transparent,
dpi = 300,
...
hist_MOD = histogram(RPLC_pH3_pH26_data.Modifier./100,
xlims = (0,1),
linecolor=:transparent,
dpi = 300,
xlabel = ("Φ"),
...
annotate!(p[1], 150, 18, text("a)", :left, 18))
...
savefig("Plots\\MW XlogP plot.png")
